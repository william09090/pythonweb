...
SECRET_KEY = 'django-insecure-lzr!^3@%ge(lyhyf=-4-sv9#%mv^lo*%5yy^^@3!*yny67_21h'
...
INSTALLED_APPS = [
    'tasks',  # Certifique-se de que este é o nome correto do seu app
...
LOGIN_URL = 'login'  # Nome da URL de login que você definiu
